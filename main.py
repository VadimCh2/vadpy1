...
from pywebio.output import put_markdown, put_image, put_text
...
quantity_caviar = slider(label="How much caviar do you like?", min_value=0, max_value=1000, value=1, step=10)
quantity_caviar = quantity_caviar / 10
...
total_cost = cost_pizza + cost_caviar
...
if cost_caviar:
    put_text(f"🍕cost_caviar: {quantity_caviar} / {prices.PRICE_CAVIAR_10g} grn/10g = {cost_caviar}")
